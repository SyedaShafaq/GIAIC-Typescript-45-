...
let sentence: string = `You Have To Believe In Yourself When No One Else Does`;
console.log(sentence);

let sentence2: string = sentence.toLowerCase();
console.log(
  `Yes my string convert into Lower case function` + " " + `"${sentence2}"`
);
...
let color: string[] = [`Red`, `Blue`, `Green`, `yellow`, `white`];
console.log(color);
