...
let guestList:string[]= [ 'Zainab', 'Aiman', 'Anaya', 'Shifa'];
console.log(guestList);

// Add one new guest to the beginning of your array

let newGuestList:any= guestList.unshift(`Minha`);
console.log(guestList);
...
let messages:string = `"Exciting news! I've just found a big dinner table that can accommodate more guests. If you'd like to join us for a delicious meal and great company`;
